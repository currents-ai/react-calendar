...
class DateLib {
  ...
  constructor(options, overrides) {
    ...
    this.differenceInCalendarDays = (dateLeft, dateRight) => {
      return this.overrides?.differenceInCalendarDays?.(dateLeft, dateRight) ?? dateFns.differenceInCalendarDays(dateLeft, dateRight);
    };
    /**
    ...
    this.differenceInCalendarMonths = (dateLeft, dateRight) => {
      return this.overrides?.differenceInCalendarMonths?.(dateLeft, dateRight) ?? dateFns.differenceInCalendarMonths(dateLeft, dateRight);
    };
    /**
    ...
    this.eachMonthOfInterval = interval => {
      return this.overrides?.eachMonthOfInterval?.(interval) ?? dateFns.eachMonthOfInterval(interval);
    };
    /**
    ...
    this.endOfWeek = (date, options) => {
      return this.overrides?.endOfWeek?.(date, options ?? this.options) ?? dateFns.endOfWeek(date, options ?? this.options);
    };
    /**
    ...
    this.format = (date, formatStr, options) => {
      const formatted = this.overrides?.format?.(date, formatStr, options ?? this.options) ?? dateFns.format(date, formatStr, options ?? this.options);
    ...
    this.getWeek = (date, options) => {
      return this.overrides?.getWeek?.(date, options ?? this.options) ?? dateFns.getWeek(date, options ?? this.options);
    };
    /**
    ...
    this.isAfter = (date, dateToCompare) => {
      return this.overrides?.isAfter?.(date, dateToCompare) ?? dateFns.isAfter(date, dateToCompare);
    };
    /**
    ...
    this.isBefore = (date, dateToCompare) => {
      return this.overrides?.isBefore?.(date, dateToCompare) ?? dateFns.isBefore(date, dateToCompare);
    };
    /**
    ...
    this.isSameDay = (dateLeft, dateRight) => {
      return this.overrides?.isSameDay?.(dateLeft, dateRight) ?? dateFns.isSameDay(dateLeft, dateRight);
    };
    /**
    ...
    this.isSameMonth = (dateLeft, dateRight) => {
      return this.overrides?.isSameMonth?.(dateLeft, dateRight) ?? dateFns.isSameMonth(dateLeft, dateRight);
    };
    /**
    ...
    this.isSameYear = (dateLeft, dateRight) => {
      return this.overrides?.isSameYear?.(dateLeft, dateRight) ?? dateFns.isSameYear(dateLeft, dateRight);
    };
    /**
...
function Chevron(props) {
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    height: size,
    viewBox: "0 0 24 24"
  }, orientation === "up" && (/*#__PURE__*/React.createElement("polygon", {
    points: "6.77 17 12.5 11.43 18.24 17 20 15.28 12.5 8 5 15.28"
  })), orientation === "down" && (/*#__PURE__*/React.createElement("polygon", {
    points: "6.77 8 12.5 13.57 18.24 8 20 9.72 12.5 17 5 9.72"
  })), orientation === "left" && (/*#__PURE__*/React.createElement("polygon", {
    points: "16 18.112 9.81111111 12 16 5.87733333 14.0888889 4 6 12 14.0888889 20"
  })), orientation === "right" && (/*#__PURE__*/React.createElement("polygon", {
...
function Dropdown(props) {
  ...
  return /*#__PURE__*/React.createElement("span", {
  ...
  }, /*#__PURE__*/React.createElement(components.Select, {
    ...
    label,
    disabled
  }) => (/*#__PURE__*/React.createElement(components.Option, {
    key: value,
    value: value,
    disabled: disabled
    ...
    "aria-hidden": true
  }, selectedOption?.label, /*#__PURE__*/React.createElement(components.Chevron, {
    orientation: "down",
    size: 18,
...
/** @ignore */
const dayPickerContext = /*#__PURE__*/React.createContext(undefined);
/**
...
function MonthsDropdown(props) {
  ...
  return /*#__PURE__*/React.createElement(components.Dropdown, {
    ...props
  });
}
...
function Nav(props) {
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...navProps
  }, /*#__PURE__*/React.createElement(components.PreviousMonthButton, {
    type: "button",
  ...
  }, /*#__PURE__*/React.createElement(components.Chevron, {
    disabled: previousMonth ? undefined : true,
    className: classNames[UI.Chevron],
    orientation: "left"
  })), /*#__PURE__*/React.createElement(components.NextMonthButton, {
    type: "button",
...
function DayPicker(props) {
  ...
  return /*#__PURE__*/React.createElement(dayPickerContext.Provider, {
    value: contextValue
  }, /*#__PURE__*/React.createElement(components.Root, {
  ...
  }, !props.hideNavigation && (/*#__PURE__*/React.createElement(components.Nav, {
    ...
    }, /*#__PURE__*/React.createElement(components.MonthCaption, {
    ...
    }, formatCaption(calendarMonth.date, dateLib.options, dateLib)))) : (/*#__PURE__*/React.createElement(components.CaptionLabel, {
      className: classNames[UI.CaptionLabel],
      role: "status",
      "aria-live": "polite"
    }, formatCaption(calendarMonth.date, dateLib.options, dateLib)))), /*#__PURE__*/React.createElement(components.MonthGrid, {
      role: "grid",
      "aria-multiselectable": mode === "multiple" || mode === "range",
      "aria-label": labelGrid(calendarMonth.date, dateLib.options, dateLib) || undefined,
      className: classNames[UI.MonthGrid],
      style: styles?.[UI.MonthGrid]
    }, !props.hideWeekdays && (/*#__PURE__*/React.createElement(components.Weekdays, {
      "data-animated-weekdays": props.animate ? "true" : undefined,
      className: classNames[UI.Weekdays],
      style: styles?.[UI.Weekdays]
    }, showWeekNumber && (/*#__PURE__*/React.createElement(components.WeekNumberHeader, {
      "aria-label": labelWeekNumberHeader(dateLib.options),
      className: classNames[UI.WeekNumberHeader],
      style: styles?.[UI.WeekNumberHeader],
      scope: "col"
    }, formatWeekNumberHeader())), weekdays.map((weekday, i) => (/*#__PURE__*/React.createElement(components.Weekday, {
      "aria-label": labelWeekday(weekday, dateLib.options, dateLib),
      className: classNames[UI.Weekday],
      key: i,
      style: styles?.[UI.Weekday],
      scope: "col"
    }, formatWeekdayName(weekday, dateLib.options, dateLib)))))), /*#__PURE__*/React.createElement(components.Weeks, {
      "data-animated-weeks": props.animate ? "true" : undefined,
      className: classNames[UI.Weeks],
      style: styles?.[UI.Weeks]
    }, calendarMonth.weeks.map((week, weekIndex) => {
      return /*#__PURE__*/React.createElement(components.Week, {
        className: classNames[UI.Week],
        key: week.weekNumber,
        style: styles?.[UI.Week],
        week: week
      }, showWeekNumber && (/*#__PURE__*/React.createElement(components.WeekNumber, {
        week: week,
