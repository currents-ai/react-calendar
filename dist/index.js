...
const N5=({color:C="currentColor",size:e=24,className:l,...i})=>t.createElement("svg",{viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",width:e,height:e,fill:C,...i,className:"remixicon "+(l||"")},t.createElement("path",{d:"M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 10H4V19H20V10ZM15.0355 11.136L16.4497 12.5503L11.5 17.5L7.96447 13.9645L9.37868 12.5503L11.5 14.6716L15.0355 11.136ZM7 5H4V8H20V5H17V6H15V5H9V6H7V5Z"})),B5=({color:C="currentColor",size:e=24,className:l,...i})=>t.createElement("svg",{viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",width:e,height:e,fill:C,...i,className:"remixicon "+(l||"")},t.createElement("path",{d:"M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM11 13V17H6V13H11ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z"})),R5=({color:C="currentColor",size:e=24,className:l,...i})=>t.createElement("svg",{viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",width:e,height:e,fill:C,...i,className:"remixicon "+(l||"")},t.createElement("path",{d:"M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z"})),M6=({color:C="currentColor",size:e=24,className:l,...i})=>t.createElement("svg",{viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",width:e,height:e,fill:C,...i,className:"remixicon "+(l||"")},t.createElement("path",{d:"M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z"}));
...
function EventItem(_a) {
  ...
  var displayStart = t.useMemo(function () {
    return currentTime || new Date(event.start);
  }, [currentTime, event.start]);
  var displayEnd = t.useMemo(function () {
  ...
  var durationMinutes = t.useMemo(function () {
...
const useIsomorphicLayoutEffect$1 = canUseDOM ? t.useLayoutEffect : t.useEffect;

function useEvent(handler) {
  const handlerRef = t.useRef(handler);
...
function useInterval() {
  const intervalRef = t.useRef(null);
  const set = t.useCallback((listener, duration) => {
    intervalRef.current = setInterval(listener, duration);
  }, []);
  const clear = t.useCallback(() => {
...
function useNodeRef(onChange) {
  ...
  const node = t.useRef(null);
  const setNodeRef = t.useCallback(element => {
...
function useAnnouncement() {
  const [announcement, setAnnouncement] = t.useState('');
  const announce = t.useCallback(value => {
    if (value != null) {
...
const DndMonitorContext = /*#__PURE__*/t.createContext(null);

function useDndMonitor(listener) {
  const registerListener = t.useContext(DndMonitorContext);
  t.useEffect(() => {
    if (!registerListener) {
...
function useDndMonitorProvider() {
  const [listeners] = t.useState(() => new Set());
  const registerListener = t.useCallback(listener => {
    listeners.add(listener);
    return () => listeners.delete(listener);
  }, [listeners]);
  const dispatch = t.useCallback(_ref => {
    let {
      type,
      event
    } = _ref;
...
function Accessibility(_ref) {
  ...
  const markup = t.createElement(t.Fragment, null, t.createElement(HiddenText, {
...
function useSensors() {
  ...
  return t.useMemo(() => [...sensors].filter(sensor => sensor != null), // eslint-disable-next-line react-hooks/exhaustive-deps
  [...sensors]);
}
...
function useAutoScroller(_ref) {
  ...
  const scrollSpeed = t.useRef({
    x: 0,
    y: 0
  });
  const scrollDirection = t.useRef({
    x: 0,
    y: 0
  });
  const rect = t.useMemo(() => {
    switch (activator) {
  ...
  const autoScroll = t.useCallback(() => {
  ...
  const sortedScrollableAncestors = t.useMemo(() => order === TraversalOrder.TreeOrder ? [...scrollableAncestors].reverse() : scrollableAncestors, [order, scrollableAncestors]);
  t.useEffect(() => {
...
function useCombineActivators(sensors, getSyntheticHandler) {
  return t.useMemo(() => sensors.reduce((accumulator, sensor) => {
    const {
      sensor: Sensor
    } = sensor;
...
function useDroppableMeasuring(containers, _ref) {
  ...
  const [queue, setQueue] = t.useState(null);
  const {
    frequency,
    measure,
    strategy
  } = config;
  const containersRef = t.useRef(containers);
  const disabled = isDisabled();
  const disabledRef = useLatestValue(disabled);
  const measureDroppableContainers = t.useCallback(function (ids) {
    if (ids === void 0) {
      ids = [];
    }
...
function useMutationObserver(_ref) {
  ...
  const mutationObserver = t.useMemo(() => {
...
function useResizeObserver(_ref) {
  ...
  const resizeObserver = t.useMemo(() => {
...
function useRect(element, measure, fallbackRect) {
  ...
  const [rect, setRect] = t.useState(null);
...
function useScrollableAncestors(node) {
  const previousNode = t.useRef(node);
...
function useScrollOffsets(elements) {
  const [scrollCoordinates, setScrollCoordinates] = t.useState(null);
  const prevElements = t.useRef(elements); // To-do: Throttle the handleScroll callback

  const handleScroll = t.useCallback(event => {
...
function useScrollOffsetsDelta(scrollOffsets, dependencies) {
  ...
  const initialScrollOffsets = t.useRef(null);
  t.useEffect(() => {
...
function useWindowRect(element) {
  return t.useMemo(() => element ? getWindowClientRect(element) : null, [element]);
}
...
function useRects(elements, measure) {
  ...
  const [rects, setRects] = t.useState(defaultValue$2);
...
function useDragOverlayMeasuring(_ref) {
  ...
  const [rect, setRect] = t.useState(null);
  const handleResize = t.useCallback(entries => {
    for (const {
      target
    } of entries) {
  ...
  const handleNodeChange = t.useCallback(element => {
...
const InternalContext = /*#__PURE__*/t.createContext(defaultInternalContext);
const PublicContext = /*#__PURE__*/t.createContext(defaultPublicContext);
...
function useLayoutShiftScrollCompensation(_ref) {
  ...
  const initialized = t.useRef(false);
  const {
    x,
    y
...
const ActiveDraggableContext = /*#__PURE__*/t.createContext({ ...defaultCoordinates,
  scaleX: 1,
  scaleY: 1
});
var Status;
...
const DndContext = /*#__PURE__*/t.memo(function DndContext(_ref) {
  ...
  const store = t.useReducer(reducer, undefined, getInitialState);
  const [state, dispatch] = store;
  const [dispatchMonitorEvent, registerMonitorListener] = useDndMonitorProvider();
  const [status, setStatus] = t.useState(Status.Uninitialized);
  ...
  const activeRects = t.useRef({
    initial: null,
    translated: null
  });
  const active = t.useMemo(() => {
    var _node$data;
  ...
  const activeRef = t.useRef(null);
  const [activeSensor, setActiveSensor] = t.useState(null);
  const [activatorEvent, setActivatorEvent] = t.useState(null);
  const latestProps = useLatestValue(props, Object.values(props));
  const draggableDescribedById = useUniqueId("DndDescribedBy", id);
  const enabledDroppableContainers = t.useMemo(() => droppableContainers.getEnabled(), [droppableContainers]);
  ...
  const activationCoordinates = t.useMemo(() => activatorEvent ? getEventCoordinates(activatorEvent) : null, [activatorEvent]);
  ...
  const [over, setOver] = t.useState(null); // When there is no drag overlay used, we need to account for the
  // window scroll delta

  const appliedTranslate = usesDragOverlay ? modifiedTranslate : add(modifiedTranslate, activeNodeScrollDelta);
  const transform = adjustScale(appliedTranslate, (_over$rect = over == null ? void 0 : over.rect) != null ? _over$rect : null, activeNodeRect);
  const activeSensorRef = t.useRef(null);
  const instantiateSensor = t.useCallback((event, _ref2) => {
    let {
      sensor: Sensor,
      options
    } = _ref2;
  ...
  [draggableNodes]);
  const bindActivatorToSensorInstantiator = t.useCallback((handler, sensor) => {
    return (event, active) => {
  ...
  const internalContext = t.useMemo(() => {
    const context = {
      activatorEvent,
      activators,
      active,
  ...
  return t.createElement(DndMonitorContext.Provider, {
    value: registerMonitorListener
  }, t.createElement(InternalContext.Provider, {
    value: internalContext
  }, t.createElement(PublicContext.Provider, {
    value: publicContext
  }, t.createElement(ActiveDraggableContext.Provider, {
    value: transform
  }, children)), t.createElement(RestoreFocus, {
    disabled: (accessibility == null ? void 0 : accessibility.restoreFocus) === false
  })), t.createElement(Accessibility, { ...accessibility,
...
const NullContext = /*#__PURE__*/t.createContext(null);
...
function useDraggable(_ref) {
  ...
  const transform = t.useContext(isDragging ? ActiveDraggableContext : NullContext);
  ...
  [draggableNodes, id]);
  const memoizedAttributes = t.useMemo(() => ({
    role,
    tabIndex,
...
function useDndContext() {
  return t.useContext(PublicContext);
}
...
function useDroppable(_ref) {
  ...
  const previous = t.useRef({
    disabled
  });
  const resizeObserverConnected = t.useRef(false);
  const rect = t.useRef(null);
  const callbackId = t.useRef(null);
  const {
  ...
  const handleResize = t.useCallback(() => {
  ...
  const handleNodeChange = t.useCallback((newElement, previousElement) => {
    if (!resizeObserver) {
      return;
    }
...
function AnimationManager(_ref) {
  ...
  const [clonedChildren, setClonedChildren] = t.useState(null);
  const [element, setElement] = t.useState(null);
  ...
  return t.createElement(t.Fragment, null, children, clonedChildren ? t.cloneElement(clonedChildren, {
    ref: setElement
  }) : null);
}
...
function NullifiedContextProvider(_ref) {
  ...
  return t.createElement(InternalContext.Provider, {
...
const PositionedOverlay = /*#__PURE__*/t.forwardRef((_ref, ref) => {
  let {
    as,
    activatorEvent,
    adjustScale,
...
const DragOverlay = /*#__PURE__*/t.memo(_ref => {
  let {
    adjustScale = false,
    children,
  ...
  const transform = t.useContext(ActiveDraggableContext);
  ...
  return t.createElement(NullifiedContextProvider, null, t.createElement(AnimationManager, {
    animation: dropAnimation
  }, active && key ? t.createElement(PositionedOverlay, {
    key: key,
    id: active.id,
    ref: ref,
    as: wrapperElement,
...
// Create the context
var CalendarDndContext = /*#__PURE__*/t.createContext({
  activeEvent: null,
  activeId: null,
  activeView: null,
  currentTime: null,
...
var useCalendarDnd = function () {
  return t.useContext(CalendarDndContext);
};
function CalendarDndProvider(_a) {
  var _b, _c;
  var children = _a.children,
    onEventUpdate = _a.onEventUpdate;
  var _d = t.useState(null),
    activeEvent = _d[0],
    setActiveEvent = _d[1];
  var _e = t.useState(null),
    activeId = _e[0],
    setActiveId = _e[1];
  var _f = t.useState(null),
    activeView = _f[0],
    setActiveView = _f[1];
  var _g = t.useState(null),
    currentTime = _g[0],
    setCurrentTime = _g[1];
  var _h = t.useState(null),
    eventHeight = _h[0],
    setEventHeight = _h[1];
  var _j = t.useState(false),
    isMultiDay = _j[0],
    setIsMultiDay = _j[1];
  var _k = t.useState(null),
    multiDayWidth = _k[0],
    setMultiDayWidth = _k[1];
  var _l = t.useState(null),
    dragHandlePosition = _l[0],
    setDragHandlePosition = _l[1];
  // Store original event dimensions
  var eventDimensions = t.useRef({
    height: 0
  });
  ...
  return jsxRuntime.jsx(DndContext, {
    ...
    children: jsxRuntime.jsxs(CalendarDndContext.Provider, {
      ...
      children: [children, jsxRuntime.jsx(DragOverlay, {
        adjustScale: false,
        dropAnimation: null,
...
function DayView(_a) {
  ...
  var dayEvents = t.useMemo(function () {
    return events.filter(function (event) {
      var eventStart = new Date(event.start);
      var eventEnd = new Date(event.end);
  ...
  var allDayEvents = t.useMemo(function () {
  ...
  var timeEvents = t.useMemo(function () {
    return dayEvents.filter(function (event) {
  ...
  var positionedEvents = t.useMemo(function () {
    var result = [];
    var dayStart = dateFns.startOfDay(currentDate);
...
function useComposedRefs(...refs) {
  return t__namespace.useCallback(composeRefs(...refs), refs);
}
...
function createSlot(ownerName) {
  ...
  const Slot2 = t__namespace.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = t__namespace.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (t__namespace.Children.count(newElement) > 1) return t__namespace.Children.only(null);
          return t__namespace.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return /* @__PURE__ */ jsxRuntime.jsx(SlotClone, { ...slotProps, ref: forwardedRef, children: t__namespace.isValidElement(newElement) ? t__namespace.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone(ownerName) {
  const SlotClone = t__namespace.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (t__namespace.isValidElement(children)) {
      const childrenRef = getElementRef$1(children);
      const props2 = mergeProps(slotProps, children.props);
      if (children.type !== t__namespace.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return t__namespace.cloneElement(children, props2);
    }
    return t__namespace.Children.count(children) > 1 ? t__namespace.Children.only(null) : null;
  });
...
function isSlottable(child) {
  return t__namespace.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER;
}
...
class DateLib {
    ...
    constructor(options, overrides) {
        ...
        this.addDays = (date, amount) => {
            return this.overrides?.addDays?.(date, amount) ?? dateFns.addDays(date, amount);
        };
        /**
        ...
        this.addMonths = (date, amount) => {
            return this.overrides?.addMonths?.(date, amount) ?? dateFns.addMonths(date, amount);
        };
        /**
        ...
        this.addWeeks = (date, amount) => {
            return this.overrides?.addWeeks?.(date, amount) ?? dateFns.addWeeks(date, amount);
        };
        /**
        ...
        this.addYears = (date, amount) => {
            return this.overrides?.addYears?.(date, amount) ?? dateFns.addYears(date, amount);
        };
        /**
        ...
        this.endOfISOWeek = (date) => {
            return this.overrides?.endOfISOWeek?.(date) ?? dateFns.endOfISOWeek(date);
        };
        /**
        ...
        this.endOfMonth = (date) => {
            return this.overrides?.endOfMonth?.(date) ?? dateFns.endOfMonth(date);
        };
        /**
        ...
        this.endOfWeek = (date, options) => {
            return (this.overrides?.endOfWeek?.(date, options ?? this.options) ??
                dateFns.endOfWeek(date, options ?? this.options));
        };
        /**
         ...
         */
        this.endOfYear = (date) => {
            return this.overrides?.endOfYear?.(date) ?? dateFns.endOfYear(date);
        };
        /**
        ...
        this.format = (date, formatStr, options) => {
            const formatted = this.overrides?.format?.(date, formatStr, options ?? this.options) ??
                dateFns.format(date, formatStr, options ?? this.options);
        ...
        this.getISOWeek = (date) => {
            return this.overrides?.getISOWeek?.(date) ?? dateFns.getISOWeek(date);
        };
        /**
         ...
         */
        this.getMonth = (date) => {
            return this.overrides?.getMonth?.(date) ?? dateFns.getMonth(date);
        };
        /**
         ...
         */
        this.getYear = (date) => {
            return this.overrides?.getYear?.(date) ?? dateFns.getYear(date);
        };
        /**
        ...
        this.getWeek = (date, options) => {
            return (this.overrides?.getWeek?.(date, options ?? this.options) ??
                dateFns.getWeek(date, options ?? this.options));
        };
        /**
         ...
         */
        this.isDate = (value) => {
            return this.overrides?.isDate?.(value) ?? dateFns.isDate(value);
        };
        /**
         ...
         */
        this.max = (dates) => {
            return this.overrides?.max?.(dates) ?? dateFns.max(dates);
        };
        /**
         ...
         */
        this.min = (dates) => {
            return this.overrides?.min?.(dates) ?? dateFns.min(dates);
        };
        /**
        ...
        this.setMonth = (date, month) => {
            return this.overrides?.setMonth?.(date, month) ?? dateFns.setMonth(date, month);
        };
        /**
        ...
        this.setYear = (date, year) => {
            return this.overrides?.setYear?.(date, year) ?? dateFns.setYear(date, year);
        };
        /**
        ...
        this.startOfDay = (date) => {
            return this.overrides?.startOfDay?.(date) ?? dateFns.startOfDay(date);
        };
        /**
        ...
        this.startOfISOWeek = (date) => {
            return this.overrides?.startOfISOWeek?.(date) ?? dateFns.startOfISOWeek(date);
        };
        /**
        ...
        this.startOfMonth = (date) => {
            return this.overrides?.startOfMonth?.(date) ?? dateFns.startOfMonth(date);
        };
        /**
        ...
        this.startOfWeek = (date) => {
            return (this.overrides?.startOfWeek?.(date) ?? dateFns.startOfWeek(date, this.options));
        };
        /**
        ...
        this.startOfYear = (date) => {
            return this.overrides?.startOfYear?.(date) ?? dateFns.startOfYear(date);
        };
...
function Chevron(props) {
    ...
    return (t.createElement("svg", { className: className, width: size, height: size, viewBox: "0 0 24 24" },
        ...
        orientation === "right" && (t.createElement("polygon", { points: "8 18.612 14.1888889 12.5 8 6.37733333 9.91111111 4.5 18 12.5 9.91111111 20.5" }))));
}
...
function DayButton(props) {
    ...
    return t.createElement("button", { ref: ref, ...buttonProps });
}
...
function Dropdown(props) {
    ...
    return (t.createElement("span", { "data-disabled": selectProps.disabled, className: classNames[UI.DropdownRoot] },
        t.createElement(components.Select, { className: cssClassSelect, ...selectProps }, options?.map(({ value, label, disabled }) => (t.createElement(components.Option, { key: value, value: value, disabled: disabled }, label)))),
        t.createElement("span", { className: classNames[UI.CaptionLabel], "aria-hidden": true },
            selectedOption?.label,
            t.createElement(components.Chevron, { orientation: "down", size: 18, className: classNames[UI.Chevron] }))));
}
...
/** @ignore */
const dayPickerContext = t.createContext(undefined);
/**
...
function useDayPicker() {
    const context = t.useContext(dayPickerContext);
...
function MonthsDropdown(props) {
    ...
    return t.createElement(components.Dropdown, { ...props });
}
...
function Nav(props) {
    ...
    const handleNextClick = t.useCallback((e) => {
        if (nextMonth) {
            onNextClick?.(e);
        }
    }, [nextMonth, onNextClick]);
    const handlePreviousClick = t.useCallback((e) => {
        if (previousMonth) {
            onPreviousClick?.(e);
        }
    }, [previousMonth, onPreviousClick]);
    return (t.createElement("nav", { ...navProps },
        t.createElement(components.PreviousMonthButton, { type: "button", className: classNames[UI.PreviousMonthButton], tabIndex: previousMonth ? undefined : -1, "aria-disabled": previousMonth ? undefined : true, "aria-label": labelPrevious(previousMonth), onClick: handlePreviousClick },
            t.createElement(components.Chevron, { disabled: previousMonth ? undefined : true, className: classNames[UI.Chevron], orientation: "left" })),
        t.createElement(components.NextMonthButton, { type: "button", className: classNames[UI.NextMonthButton], tabIndex: nextMonth ? undefined : -1, "aria-disabled": nextMonth ? undefined : true, "aria-label": labelNext(nextMonth), onClick: handleNextClick },
            t.createElement(components.Chevron, { disabled: nextMonth ? undefined : true, orientation: "right", className: classNames[UI.Chevron] }))));
}
...
function NextMonthButton(props) {
    const { components } = useDayPicker();
    return t.createElement(components.Button, { ...props });
}
...
function Weekdays(props) {
    return (t.createElement("thead", { "aria-hidden": true },
...
function useAnimation(rootElRef, enabled, { classNames, months, focused, dateLib }) {
    const previousRootElSnapshotRef = t.useRef(null);
    const previousMonthsRef = t.useRef(months);
    const animatingRef = t.useRef(false);
    t.useLayoutEffect(() => {
...
function useControlledValue(defaultValue, controlledValue) {
    const [uncontrolledValue, setValue] = t.useState(defaultValue);
...
function useFocus(props, calendar, getModifiers, isSelected, dateLib) {
    ...
    const [lastFocused, setLastFocused] = t.useState();
    const focusTarget = calculateFocusTarget(calendar.days, getModifiers, isSelected || (() => false), lastFocused);
    const [focusedDay, setFocused] = t.useState(autoFocus ? focusTarget : undefined);
    const blur = () => {
...
function DayPicker(props) {
    const { components, formatters, labels, dateLib, locale, classNames } = t.useMemo(() => {
    ...
    const weekdays = t.useMemo(() => getWeekdays(dateLib, props.ISOWeek), [dateLib, props.ISOWeek]);
    const isInteractive = mode !== undefined || onDayClick !== undefined;
    const handlePreviousClick = t.useCallback(() => {
        if (!previousMonth)
            return;
        goToMonth(previousMonth);
        onPrevClick?.(previousMonth);
    }, [previousMonth, goToMonth, onPrevClick]);
    const handleNextClick = t.useCallback(() => {
        if (!nextMonth)
            return;
        goToMonth(nextMonth);
        onNextClick?.(nextMonth);
    }, [goToMonth, nextMonth, onNextClick]);
    const handleDayClick = t.useCallback((day, m) => (e) => {
        e.preventDefault();
        e.stopPropagation();
        setFocused(day);
        select?.(day.date, m, e);
    ...
    const handleDayFocus = t.useCallback((day, m) => (e) => {
        setFocused(day);
        onDayFocus?.(day.date, m, e);
    }, [onDayFocus, setFocused]);
    const handleDayBlur = t.useCallback((day, m) => (e) => {
        blur();
        onDayBlur?.(day.date, m, e);
    }, [blur, onDayBlur]);
    const handleDayKeyDown = t.useCallback((day, modifiers) => (e) => {
        const keyMap = {
    ...
    const handleDayMouseEnter = t.useCallback((day, modifiers) => (e) => {
        onDayMouseEnter?.(day.date, modifiers, e);
    }, [onDayMouseEnter]);
    const handleDayMouseLeave = t.useCallback((day, modifiers) => (e) => {
        onDayMouseLeave?.(day.date, modifiers, e);
    }, [onDayMouseLeave]);
    const handleMonthChange = t.useCallback((date) => (e) => {
        const selectedMonth = Number(e.target.value);
        const month = dateLib.setMonth(dateLib.startOfMonth(date), selectedMonth);
        goToMonth(month);
    }, [dateLib, goToMonth]);
    const handleYearChange = t.useCallback((date) => (e) => {
        const selectedYear = Number(e.target.value);
        const month = dateLib.setYear(dateLib.startOfMonth(date), selectedYear);
        goToMonth(month);
    }, [dateLib, goToMonth]);
    const { className, style } = t.useMemo(() => ({
    ...
    return (t.createElement(dayPickerContext.Provider, { value: contextValue },
        t.createElement(components.Root, { rootRef: props.animate ? rootElRef : undefined, className: className, style: style, dir: props.dir, id: props.id, lang: props.lang, nonce: props.nonce, title: props.title, role: props.role, "aria-label": props["aria-label"], ...dataAttributes },
            t.createElement(components.Months, { className: classNames[UI.Months], style: styles?.[UI.Months] },
                !props.hideNavigation && (t.createElement(components.Nav, { "data-animated-nav": props.animate ? "true" : undefined, className: classNames[UI.Nav], style: styles?.[UI.Nav], "aria-label": labelNav(), onPreviousClick: handlePreviousClick, onNextClick: handleNextClick, previousMonth: previousMonth, nextMonth: nextMonth })),
                months.map((calendarMonth, displayIndex) => {
                    ...
                    return (t.createElement(components.Month, { "data-animated-month": props.animate ? "true" : undefined, className: classNames[UI.Month], style: styles?.[UI.Month], key: displayIndex, displayIndex: displayIndex, calendarMonth: calendarMonth },
                        t.createElement(components.MonthCaption, { "data-animated-caption": props.animate ? "true" : undefined, className: classNames[UI.MonthCaption], style: styles?.[UI.MonthCaption], calendarMonth: calendarMonth, displayIndex: displayIndex }, captionLayout?.startsWith("dropdown") ? (t.createElement(components.DropdownNav, { className: classNames[UI.Dropdowns], style: styles?.[UI.Dropdowns] },
                            captionLayout === "dropdown" ||
                                captionLayout === "dropdown-months" ? (t.createElement(components.MonthsDropdown, { className: classNames[UI.MonthsDropdown], "aria-label": labelMonthDropdown(), classNames: classNames, components: components, disabled: Boolean(props.disableNavigation), onChange: handleMonthChange(calendarMonth.date), options: dropdownMonths, style: styles?.[UI.Dropdown], value: dateLib.getMonth(calendarMonth.date) })) : (t.createElement("span", null, formatMonthDropdown(calendarMonth.date, dateLib))),
                            captionLayout === "dropdown" ||
                                captionLayout === "dropdown-years" ? (t.createElement(components.YearsDropdown, { className: classNames[UI.YearsDropdown], "aria-label": labelYearDropdown(dateLib.options), classNames: classNames, components: components, disabled: Boolean(props.disableNavigation), onChange: handleYearChange(calendarMonth.date), options: dropdownYears, style: styles?.[UI.Dropdown], value: dateLib.getYear(calendarMonth.date) })) : (t.createElement("span", null, formatYearDropdown(calendarMonth.date, dateLib))),
                            t.createElement("span", { role: "status", "aria-live": "polite", style: {
                                    ...
                                    whiteSpace: "nowrap",
                                    wordWrap: "normal"
                                } }, formatCaption(calendarMonth.date, dateLib.options, dateLib)))) : (t.createElement(components.CaptionLabel, { className: classNames[UI.CaptionLabel], role: "status", "aria-live": "polite" }, formatCaption(calendarMonth.date, dateLib.options, dateLib)))),
                        t.createElement(components.MonthGrid, { role: "grid", "aria-multiselectable": mode === "multiple" || mode === "range", "aria-label": labelGrid(calendarMonth.date, dateLib.options, dateLib) ||
                                undefined, className: classNames[UI.MonthGrid], style: styles?.[UI.MonthGrid] },
                            !props.hideWeekdays && (t.createElement(components.Weekdays, { "data-animated-weekdays": props.animate ? "true" : undefined, className: classNames[UI.Weekdays], style: styles?.[UI.Weekdays] },
                                showWeekNumber && (t.createElement(components.WeekNumberHeader, { "aria-label": labelWeekNumberHeader(dateLib.options), className: classNames[UI.WeekNumberHeader], style: styles?.[UI.WeekNumberHeader], scope: "col" }, formatWeekNumberHeader())),
                                weekdays.map((weekday, i) => (t.createElement(components.Weekday, { "aria-label": labelWeekday(weekday, dateLib.options, dateLib), className: classNames[UI.Weekday], key: i, style: styles?.[UI.Weekday], scope: "col" }, formatWeekdayName(weekday, dateLib.options, dateLib)))))),
                            t.createElement(components.Weeks, { "data-animated-weeks": props.animate ? "true" : undefined, className: classNames[UI.Weeks], style: styles?.[UI.Weeks] }, calendarMonth.weeks.map((week, weekIndex) => {
                                return (t.createElement(components.Week, { className: classNames[UI.Week], key: week.weekNumber, style: styles?.[UI.Week], week: week },
                                    showWeekNumber && (t.createElement(components.WeekNumber, { week: week, style: styles?.[UI.WeekNumber], "aria-label": labelWeekNumber(week.weekNumber, {
                                            locale
                                    ...
                                    week.days.map((day) => {
                                        ...
                                        const ariaLabel = !isInteractive && !modifiers.hidden
                                            ...
                                            : undefined;
                                        return (t.createElement(components.Day, { key: `${dateLib.format(date, "yyyy-MM-dd")}_${dateLib.format(day.displayMonth, "yyyy-MM")}`, day: day, modifiers: modifiers, className: className.join(" "), style: style, role: "gridcell", "aria-selected": modifiers.selected || undefined, "aria-label": ariaLabel, "data-day": dateLib.format(date, "yyyy-MM-dd"), "data-month": day.outside
                                                ? dateLib.format(date, "yyyy-MM")
                                                : undefined, "data-selected": modifiers.selected || undefined, "data-disabled": modifiers.disabled || undefined, "data-hidden": modifiers.hidden || undefined, "data-outside": day.outside || undefined, "data-focused": modifiers.focused || undefined, "data-today": modifiers.today || undefined }, !modifiers.hidden && isInteractive ? (t.createElement(components.DayButton, { className: classNames[UI.DayButton], style: styles?.[UI.DayButton], type: "button", day: day, modifiers: modifiers, disabled: modifiers.disabled || undefined, tabIndex: isFocusTarget(day) ? 0 : -1, "aria-label": labelDayButton(date, modifiers, dateLib.options, dateLib), onClick: handleDayClick(day, modifiers), onBlur: handleDayBlur(day, modifiers), onFocus: handleDayFocus(day, modifiers), onKeyDown: handleDayKeyDown(day, modifiers), onMouseEnter: handleDayMouseEnter(day, modifiers), onMouseLeave: handleDayMouseLeave(day, modifiers) }, formatDay(date, dateLib.options, dateLib))) : (!modifiers.hidden &&
                                            formatDay(day.date, dateLib.options, dateLib))));
                                    })));
                            })))));
                })),
            props.footer && (t.createElement(components.Footer, { className: classNames[UI.Footer], style: styles?.[UI.Footer], role: "status", "aria-live": "polite" }, props.footer)))));
}
...
function Calendar(_a) {
  ...
  return jsxRuntime.jsx(DayPicker, __assign({
...
function createContext2(rootComponentName, defaultContext) {
  const Context = t__namespace.createContext(defaultContext);
...
var useLayoutEffect2 = globalThis?.document ? t__namespace.useLayoutEffect : () => {
};

// src/use-controllable-state.tsx
var useInsertionEffect = t__namespace[" useInsertionEffect ".trim().toString()] || useLayoutEffect2;
...
function usePrevious(value) {
  const ref = t__namespace.useRef({ value, previous: value });
  return t__namespace.useMemo(() => {
...
function useSize(element) {
  const [size, setSize] = t__namespace.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = t__namespace.useState(null);
  const [bubbleInput, setBubbleInput] = t__namespace.useState(null);
  const hasConsumerStoppedPropagationRef = t__namespace.useRef(false);
...
var CheckboxTrigger = t__namespace.forwardRef(
  ({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
    ...
    const initialCheckedStateRef = t__namespace.useRef(checked);
    t__namespace.useEffect(() => {
...
var Checkbox$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeCheckbox,
      name,
...
var CheckboxIndicator = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var CheckboxBubbleInput = t__namespace.forwardRef(
  ({ __scopeCheckbox, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = t__namespace.useRef(isIndeterminate$1(checked) ? false : checked);
    return /* @__PURE__ */ jsxRuntime.jsx(
      Primitive.input,
      {
        type: "checkbox",
...
function Checkbox(_a) {
  ...
  return jsxRuntime.jsx(Checkbox$1, __assign({
    "data-slot": "checkbox",
    ...
    children: jsxRuntime.jsx(CheckboxIndicator, {
...
var useReactId = t__namespace[" useId ".trim().toString()] || (() => void 0);
var count$1 = 0;
...
var DismissableLayerContext = t__namespace.createContext({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
var DismissableLayer = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const context = t__namespace.useContext(DismissableLayerContext);
    const [node, setNode] = t__namespace.useState(null);
    const ownerDocument = node?.ownerDocument ?? globalThis?.document;
    const [, force] = t__namespace.useState({});
...
var DismissableLayerBranch = t__namespace.forwardRef((props, forwardedRef) => {
  const context = t__namespace.useContext(DismissableLayerContext);
...
function usePointerDownOutside(onPointerDownOutside, ownerDocument = globalThis?.document) {
  ...
  const isPointerInsideReactTreeRef = t__namespace.useRef(false);
  const handleClickRef = t__namespace.useRef(() => {
  });
  t__namespace.useEffect(() => {
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
  ...
  const isFocusInsideReactTreeRef = t__namespace.useRef(false);
  t__namespace.useEffect(() => {
...
var FocusScope = t__namespace.forwardRef((props, forwardedRef) => {
  const {
    loop = false,
    trapped = false,
  ...
  const [container, setContainer] = t__namespace.useState(null);
  const onMountAutoFocus = useCallbackRef$1(onMountAutoFocusProp);
  const onUnmountAutoFocus = useCallbackRef$1(onUnmountAutoFocusProp);
  const lastFocusedElementRef = t__namespace.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContainer(node));
  const focusScope = t__namespace.useRef({
    paused: false,
    pause() {
      this.paused = true;
    },
  ...
  const handleKeyDown = t__namespace.useCallback(
    (event) => {
...
var Portal$4 = t__namespace.forwardRef((props, forwardedRef) => {
  const { container: containerProp, ...portalProps } = props;
  const [mounted, setMounted] = t__namespace.useState(false);
...
function useCallbackRef(initialValue, callback) {
    var ref = t.useState(function () { return ({
        // value
        value: initialValue,
        // last callback
        callback: callback,
...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' ? t__namespace.useLayoutEffect : t__namespace.useEffect;
...
var SideCar$1 = function (_a) {
    ...
    return t__namespace.createElement(Target, __assign({}, rest));
};
 ...
 */
var RemoveScroll = t__namespace.forwardRef(function (props, parentRef) {
    var ref = t__namespace.useRef(null);
    var _a = t__namespace.useState({
    ...
    return (t__namespace.createElement(t__namespace.Fragment, null,
        enabled && (t__namespace.createElement(SideCar, { sideCar: effectCar, removeScrollBar: removeScrollBar, shards: shards, noRelative: noRelative, noIsolation: noIsolation, inert: inert, setCallbacks: setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode: gapMode })),
        forwardProps ? (t__namespace.cloneElement(t__namespace.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef }))) : (t__namespace.createElement(Container, __assign({}, containerProps, { className: className, ref: containerRef }), children))));
});
...
var styleHookSingleton = function () {
    ...
    return function (styles, isDynamic) {
        t__namespace.useEffect(function () {
            sheet.add(styles);
            return function () {
                sheet.remove();
            };
...
var RemoveScrollBar = function (_a) {
     ...
     */
    var gap = t__namespace.useMemo(function () { return getGapWidth(gapMode); }, [gapMode]);
    return t__namespace.createElement(Style, { styles: getStyles(gap, !noRelative, gapMode, !noImportant ? '!important' : '') });
};
...
function RemoveScrollSideCar(props) {
    var shouldPreventQueue = t__namespace.useRef([]);
    var touchStartRef = t__namespace.useRef([0, 0]);
    var activeAxis = t__namespace.useRef();
    var id = t__namespace.useState(idCounter++)[0];
    var Style = t__namespace.useState(styleSingleton)[0];
    var lastProps = t__namespace.useRef(props);
    t__namespace.useEffect(function () {
    ...
    var shouldCancelEvent = t__namespace.useCallback(function (event, parent) {
    ...
    var shouldPrevent = t__namespace.useCallback(function (_event) {
        var event = _event;
    ...
    var shouldCancel = t__namespace.useCallback(function (name, delta, target, should) {
    ...
    var scrollTouchStart = t__namespace.useCallback(function (event) {
        touchStartRef.current = getTouchXY(event);
        activeAxis.current = undefined;
    }, []);
    var scrollWheel = t__namespace.useCallback(function (event) {
        shouldCancel(event.type, getDeltaXY(event), event.target, shouldCancelEvent(event, props.lockRef.current));
    }, []);
    var scrollTouchMove = t__namespace.useCallback(function (event) {
    ...
    return (t__namespace.createElement(t__namespace.Fragment, null,
        inert ? t__namespace.createElement(Style, { styles: generateStyle(id) }) : null,
        removeScrollBar ? t__namespace.createElement(RemoveScrollBar, { noRelative: props.noRelative, gapMode: props.gapMode }) : null));
}
...
var ReactRemoveScroll = t__namespace.forwardRef(function (props, ref) { return (t__namespace.createElement(RemoveScroll, __assign({}, props, { ref: ref, sideCar: SideCar }))); });
...
var Dialog$1 = (props) => {
  ...
  const triggerRef = t__namespace.useRef(null);
  const contentRef = t__namespace.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    DialogProvider,
    {
      ...
      onOpenToggle: t__namespace.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
      modal,
      children
    }
  );
...
var DialogTrigger = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DialogPortal$1 = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider$2, { scope: __scopeDialog, forceMount, children: t__namespace.Children.map(children, (child) => /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Portal$4, { asChild: true, container, children: child }) })) });
};
DialogPortal$1.displayName = PORTAL_NAME$4;
var OVERLAY_NAME = "DialogOverlay";
var DialogOverlay$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DialogOverlayImpl = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DialogContent$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DialogContentModal = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME$5, props.__scopeDialog);
    const contentRef = t__namespace.useRef(null);
...
var DialogContentNonModal = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME$5, props.__scopeDialog);
    const hasInteractedOutsideRef = t__namespace.useRef(false);
    const hasPointerDownOutsideRef = t__namespace.useRef(false);
    return /* @__PURE__ */ jsxRuntime.jsx(
      DialogContentImpl,
      {
        ...props,
...
var DialogContentImpl = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DialogTitle$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DialogDescription$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DialogClose = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
function Dialog(_a) {
  var props = __rest(_a, []);
  return jsxRuntime.jsx(Root$3, __assign({
    "data-slot": "dialog"
  }, props));
}
function DialogPortal(_a) {
  var props = __rest(_a, []);
  return jsxRuntime.jsx(Portal$3, __assign({
...
function DialogOverlay(_a) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(Overlay, __assign({
...
function DialogTitle(_a) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(Title, __assign({
...
function DialogDescription(_a) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(Description, __assign({
...
var NAME$2 = "Label";
var Label$2 = t__namespace.forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ jsxRuntime.jsx(
    Primitive.label,
    {
      ...props,
...
function Label$1(_a) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(Root$2, __assign({
    "data-slot": "label",
...
var index = typeof document !== 'undefined' ? t.useLayoutEffect : t.useEffect;
...
function useLatestRef(value) {
  const ref = t__namespace.useRef(value);
  index(() => {
    ref.current = value;
  });
  return ref;
...
function useFloating(options) {
  ...
  const [data, setData] = t__namespace.useState({
    x: 0,
    y: 0,
    strategy,
    placement,
  ...
  const [latestMiddleware, setLatestMiddleware] = t__namespace.useState(middleware);
  if (!deepEqual(latestMiddleware, middleware)) {
    setLatestMiddleware(middleware);
  }
  const [_reference, _setReference] = t__namespace.useState(null);
  const [_floating, _setFloating] = t__namespace.useState(null);
  const setReference = t__namespace.useCallback(node => {
    if (node !== referenceRef.current) {
      referenceRef.current = node;
      _setReference(node);
    }
  }, []);
  const setFloating = t__namespace.useCallback(node => {
  ...
  const referenceRef = t__namespace.useRef(null);
  const floatingRef = t__namespace.useRef(null);
  const dataRef = t__namespace.useRef(data);
  const hasWhileElementsMounted = whileElementsMounted != null;
  const whileElementsMountedRef = useLatestRef(whileElementsMounted);
  const platformRef = useLatestRef(platform);
  const openRef = useLatestRef(open);
  const update = t__namespace.useCallback(() => {
  ...
  const isMountedRef = t__namespace.useRef(false);
  index(() => {
  ...
  const refs = t__namespace.useMemo(() => ({
    reference: referenceRef,
    floating: floatingRef,
    setReference,
    setFloating
  }), [setReference, setFloating]);
  const elements = t__namespace.useMemo(() => ({
    reference: referenceEl,
    floating: floatingEl
  }), [referenceEl, floatingEl]);
  const floatingStyles = t__namespace.useMemo(() => {
    const initialStyles = {
      position: strategy,
      left: 0,
      top: 0
...
// src/arrow.tsx
var NAME$1 = "Arrow";
var Arrow$1 = t__namespace.forwardRef((props, forwardedRef) => {
...
var Popper = (props) => {
  ...
  const [anchor, setAnchor] = t__namespace.useState(null);
...
var PopperAnchor = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var PopperContent = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopper,
      side = "bottom",
    ...
    const [arrow$1, setArrow] = t__namespace.useState(null);
    ...
    const [contentZIndex, setContentZIndex] = t__namespace.useState();
    useLayoutEffect2(() => {
...
var PopperArrow = t__namespace.forwardRef(function PopperArrow2(props, forwardedRef) {
...
var Popover$1 = (props) => {
  ...
  const triggerRef = t__namespace.useRef(null);
  const [hasCustomAnchor, setHasCustomAnchor] = t__namespace.useState(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Root2$4, { ...popperScope, children: /* @__PURE__ */ jsxRuntime.jsx(
    PopoverProvider,
    {
      ...
      onOpenToggle: t__namespace.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
      hasCustomAnchor,
      onCustomAnchorAdd: t__namespace.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: t__namespace.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContent$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContentModal = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME$3, props.__scopePopover);
    const contentRef = t__namespace.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = t__namespace.useRef(false);
    t__namespace.useEffect(() => {
      const content = contentRef.current;
      if (content) return hideOthers(content);
    }, []);
...
var PopoverContentNonModal = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME$3, props.__scopePopover);
    const hasInteractedOutsideRef = t__namespace.useRef(false);
    const hasPointerDownOutsideRef = t__namespace.useRef(false);
...
var PopoverContentImpl = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
function Popover(_a) {
  var props = __rest(_a, []);
  return jsxRuntime.jsx(Root2$3, __assign({
    "data-slot": "popover"
  }, props));
}
function PopoverTrigger(_a) {
  var props = __rest(_a, []);
  return jsxRuntime.jsx(Trigger$2, __assign({
...
function PopoverContent(_a) {
  ...
  return jsxRuntime.jsx(Portal$2, {
    children: jsxRuntime.jsxs(Content2$3, __assign({
      ...
      children: [props.children, showArrow && jsxRuntime.jsx(Arrow2$1, {
...
var RovingFocusGroup = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var RovingFocusGroupImpl = t__namespace.forwardRef((props, forwardedRef) => {
  const {
  ...
  const [isTabbingBackOut, setIsTabbingBackOut] = t__namespace.useState(false);
  const handleEntryFocus = useCallbackRef$1(onEntryFocus);
  const getItems = useCollection$2(__scopeRovingFocusGroup);
  const isClickFocusRef = t__namespace.useRef(false);
  const [focusableItemsCount, setFocusableItemsCount] = t__namespace.useState(0);
  t__namespace.useEffect(() => {
    const node = ref.current;
    if (node) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    RovingFocusProvider,
    {
      ...
      loop,
      currentTabStopId,
      onItemFocus: t__namespace.useCallback(
        (tabStopId) => setCurrentTabStopId(tabStopId),
        [setCurrentTabStopId]
      ),
      onItemShiftTab: t__namespace.useCallback(() => setIsTabbingBackOut(true), []),
      onFocusableItemAdd: t__namespace.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount + 1),
        []
      ),
      onFocusableItemRemove: t__namespace.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount - 1),
        []
      ),
      children: /* @__PURE__ */ jsxRuntime.jsx(
...
var RovingFocusGroupItem = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var Radio = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRadio,
      name,
    ...
    const [button, setButton] = t__namespace.useState(null);
...
var RadioIndicator = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var RadioBubbleInput = t__namespace.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var RadioGroup$2 = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRadioGroup,
      name,
...
var RadioGroupItem$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const isArrowKeyPressedRef = t__namespace.useRef(false);
    t__namespace.useEffect(() => {
      const handleKeyDown = (event) => {
...
var RadioGroupIndicator = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
function RadioGroup$1(_a) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(Root2$2, __assign({
...
function RadioGroupItem(_a) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(Item2$2, __assign({
...
var VisuallyHidden = t__namespace.forwardRef(
  (props, forwardedRef) => {
    return /* @__PURE__ */ jsxRuntime.jsx(
      Primitive.span,
      {
...
var Select$1 = (props) => {
  ...
  const [trigger, setTrigger] = t__namespace.useState(null);
  const [valueNode, setValueNode] = t__namespace.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = t__namespace.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = t__namespace.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = t__namespace.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(Collection$1.Provider, { scope: __scopeSelect, children: /* @__PURE__ */ jsxRuntime.jsx(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: t__namespace.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: t__namespace.useCallback((option) => {
...
var SelectTrigger$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = t__namespace.useRef("touch");
...
var SelectValue$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var SelectPortal = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx(Portal$4, { asChild: true, ...props });
};
SelectPortal.displayName = PORTAL_NAME$2;
var CONTENT_NAME$2 = "SelectContent";
var SelectContent$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME$2, props.__scopeSelect);
    const [fragment, setFragment] = t__namespace.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = t__namespace.useState(null);
    const [selectedItemText, setSelectedItemText] = t__namespace.useState(
      null
    );
    const getItems = useCollection$1(__scopeSelect);
    const [isPositioned, setIsPositioned] = t__namespace.useState(false);
    const firstValidItemFoundRef = t__namespace.useRef(false);
    t__namespace.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst = t__namespace.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = t__namespace.useCallback(
    ...
    const itemRefCallback = t__namespace.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = t__namespace.useCallback(() => content?.focus(), [content]);
    const itemTextRefCallback = t__namespace.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = t__namespace.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME$2, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME$2, __scopeSelect);
  const [contentWrapper, setContentWrapper] = t__namespace.useState(null);
  const [content, setContent] = t__namespace.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection$1(__scopeSelect);
  const shouldExpandOnScrollRef = t__namespace.useRef(false);
  const shouldRepositionRef = t__namespace.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = t__namespace.useCallback(() => {
  ...
  const handleScrollButtonChange = t__namespace.useCallback(
    (node) => {
...
var SelectPopperPosition = t__namespace.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, nonce, ...viewportProps } = props;
    const contentContext = useSelectContentContext(VIEWPORT_NAME, __scopeSelect);
    const viewportContext = useSelectViewportContext(VIEWPORT_NAME, __scopeSelect);
    const composedRefs = useComposedRefs(forwardedRef, contentContext.onViewportChange);
    const prevScrollTopRef = t__namespace.useRef(0);
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "style",
        {
...
var SelectGroup = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = t__namespace.useState(textValueProp ?? "");
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: t__namespace.useCallback((node) => {
...
var SelectItemText = t__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = t__namespace.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = t__namespace.useMemo(
...
var SelectItemIndicator = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton$1 = t__namespace.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = t__namespace.useState(false);
...
var SelectScrollDownButton$1 = t__namespace.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = t__namespace.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll2 = function() {
...
var SelectScrollButtonImpl = t__namespace.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = t__namespace.useRef(null);
  const getItems = useCollection$1(__scopeSelect);
  const clearAutoScrollTimer = t__namespace.useCallback(() => {
...
var SelectSeparator = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = t__namespace.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = t__namespace.useRef("");
  const timerRef = t__namespace.useRef(0);
  const handleTypeaheadSearch = t__namespace.useCallback(
    (key) => {
  ...
  const resetTypeahead = t__namespace.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  t__namespace.useEffect(() => {
...
function Select(_a) {
  var props = __rest(_a, []);
  return jsxRuntime.jsx(Root2$1, __assign({
    "data-slot": "select"
  }, props));
}
function SelectValue(_a) {
  var props = __rest(_a, []);
  return jsxRuntime.jsx(Value, __assign({
...
function SelectTrigger(_a) {
  var className = _a.className,
    children = _a.children,
    props = __rest(_a, ["className", "children"]);
  return jsxRuntime.jsxs(Trigger$1, __assign({
    ...
    children: [children, jsxRuntime.jsx(Icon, {
      asChild: true,
...
function SelectContent(_a) {
  ...
  return jsxRuntime.jsx(Portal$1, {
    children: jsxRuntime.jsxs(Content2$2, __assign({
      ...
      children: [jsxRuntime.jsx(SelectScrollUpButton, {}), jsxRuntime.jsx(Viewport, {
...
function SelectItem(_a) {
  var className = _a.className,
    children = _a.children,
    props = __rest(_a, ["className", "children"]);
  return jsxRuntime.jsxs(Item, __assign({
    ...
    children: [jsxRuntime.jsx("span", {
      ...
      children: jsxRuntime.jsx(ItemIndicator$1, {
        children: jsxRuntime.jsx(lucideReact.CheckIcon, {
          size: 16
        })
      })
    }), jsxRuntime.jsx(ItemText, {
      children: children
    })]
  }));
}
function SelectScrollUpButton(_a) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(ScrollUpButton, __assign({
...
function SelectScrollDownButton(_a) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(ScrollDownButton, __assign({
...
function EventDialog(_a) {
  ...
  var _d = t.useState(""),
    description = _d[0],
    setDescription = _d[1];
  var _e = t.useState(new Date()),
    startDate = _e[0],
    setStartDate = _e[1];
  var _f = t.useState(new Date()),
    endDate = _f[0],
    setEndDate = _f[1];
  var _g = t.useState("".concat(DefaultStartHour, ":00")),
    startTime = _g[0],
    setStartTime = _g[1];
  var _h = t.useState("".concat(DefaultEndHour, ":00")),
    endTime = _h[0],
    setEndTime = _h[1];
  var _j = t.useState(false),
    allDay = _j[0],
  ...
  var _k = t.useState(""),
    location = _k[0],
    setLocation = _k[1];
  var _l = t.useState("sky"),
    color = _l[0],
    setColor = _l[1];
  var _m = t.useState(null),
    error = _m[0],
    setError = _m[1];
  var _o = t.useState(false),
    startDateOpen = _o[0],
    setStartDateOpen = _o[1];
  var _p = t.useState(false),
    endDateOpen = _p[0],
    setEndDateOpen = _p[1];
  ...
  var timeOptions = t.useMemo(function () {
    var options = [];
    ...
    children: jsxRuntime.jsxs(DialogContent, {
      ...
      children: [jsxRuntime.jsxs(DialogHeader, {
        ...
        children: [jsxRuntime.jsxs("div", {
          ...
          children: [jsxRuntime.jsx(Label$1, {
            htmlFor: "title",
            children: "Title"
        ...
        children: [(event === null || event === void 0 ? void 0 : event.id) && jsxRuntime.jsx(Button$1, {
          variant: "outline",
          size: "icon",
          onClick: handleDelete,
          "aria-label": "Delete event",
          children: jsxRuntime.jsx(M6, {
            size: 16,
            "aria-hidden": "true"
          })
        }), jsxRuntime.jsxs("div", {
...
function EventsPopup(_a) {
  ...
  var adjustedPosition = t.useMemo(function () {
...
function useEventVisibility(_a) {
  ...
  var contentRef = t.useRef(null);
  var observerRef = t.useRef(null);
  var _b = t.useState(null),
    contentHeight = _b[0],
  ...
  var getVisibleEventCount = t.useMemo(function () {
...
function MonthView(_a) {
  ...
  var weekdays = t.useMemo(function () {
    return Array.from({
      length: 7
    }).map(function (_, i) {
...
var Menu = (props) => {
  ...
  const [content, setContent] = t__namespace.useState(null);
  const isUsingKeyboardRef = t__namespace.useRef(false);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Root2$4, { ...popperScope, children: /* @__PURE__ */ jsxRuntime.jsx(
    MenuProvider,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          scope: __scopeMenu,
          onClose: t__namespace.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider, { scope: __scopeMenu, forceMount, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Portal$4, { asChild: true, container, children }) }) });
};
MenuPortal.displayName = PORTAL_NAME$1;
var CONTENT_NAME$1 = "MenuContent";
var [MenuContentProvider, useMenuContentContext] = createMenuContext(CONTENT_NAME$1);
var MenuContent = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME$1, props.__scopeMenu);
    const ref = t__namespace.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
...
var MenuRootContentNonModal = t__namespace.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME$1, props.__scopeMenu);
  return /* @__PURE__ */ jsxRuntime.jsx(
    MenuContentImpl,
    {
...
var MenuContentImpl = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = t__namespace.useState(null);
    const contentRef = t__namespace.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = t__namespace.useRef(0);
    const searchRef = t__namespace.useRef("");
    const pointerGraceTimerRef = t__namespace.useRef(0);
    const pointerGraceIntentRef = t__namespace.useRef(null);
    const pointerDirRef = t__namespace.useRef("right");
    const lastPointerXRef = t__namespace.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? ReactRemoveScroll : t__namespace.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = t__namespace.useCallback((event) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: t__namespace.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: t__namespace.useCallback(
          (event) => {
        ...
        onTriggerLeave: t__namespace.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ...
        onPointerGraceIntentChange: t__namespace.useCallback((intent) => {
...
var MenuGroup = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuItem = t__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs(forwardedRef, ref);
    const isPointerDownRef = t__namespace.useRef(false);
    const handleSelect = () => {
...
var MenuItemImpl = t__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs(forwardedRef, ref);
    const [isFocused, setIsFocused] = t__namespace.useState(false);
    const [textContent, setTextContent] = t__namespace.useState("");
    t__namespace.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
    const openTimerRef = t__namespace.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = t__namespace.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    t__namespace.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    t__namespace.useEffect(() => {
...
var MenuSubContent = t__namespace.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME$1, props.__scopeMenu);
...
var DropdownMenuTrigger$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuContent$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuItem$1 = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem$1 = t__namespace.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = t__namespace.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem$1 = t__namespace.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = t__namespace.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator$1 = t__namespace.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = t__namespace.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuSubTrigger$1 = t__namespace.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent$1 = t__namespace.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubTrigger = /*#__PURE__*/t__namespace.forwardRef(function (_a, ref) {
  var className = _a.className,
    inset = _a.inset,
    children = _a.children,
    props = __rest(_a, ["className", "inset", "children"]);
  return jsxRuntime.jsxs(SubTrigger2, __assign({
    ref: ref,
...
var DropdownMenuSubContent = /*#__PURE__*/t__namespace.forwardRef(function (_a, ref) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(SubContent2, __assign({
    ref: ref,
    className: cn("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[8rem] origin-[--radix-dropdown-menu-content-transform-origin] overflow-hidden rounded-md border p-1 shadow-lg", className)
  }, props));
});
DropdownMenuSubContent.displayName = SubContent2.displayName;
var DropdownMenuContent = /*#__PURE__*/t__namespace.forwardRef(function (_a, ref) {
  var className = _a.className,
    _b = _a.sideOffset,
    sideOffset = _b === void 0 ? 4 : _b,
    props = __rest(_a, ["className", "sideOffset"]);
  return jsxRuntime.jsx(Portal2, {
    children: jsxRuntime.jsx(Content2, __assign({
      ref: ref,
      sideOffset: sideOffset,
...
var DropdownMenuItem = /*#__PURE__*/t__namespace.forwardRef(function (_a, ref) {
  var className = _a.className,
    inset = _a.inset,
    props = __rest(_a, ["className", "inset"]);
  return jsxRuntime.jsx(Item2, __assign({
    ref: ref,
...
var DropdownMenuCheckboxItem = /*#__PURE__*/t__namespace.forwardRef(function (_a, ref) {
  var className = _a.className,
    children = _a.children,
    checked = _a.checked,
    props = __rest(_a, ["className", "children", "checked"]);
  return jsxRuntime.jsxs(CheckboxItem2, __assign({
    ref: ref,
    ...
    children: [jsxRuntime.jsx("span", {
      ...
      children: jsxRuntime.jsx(ItemIndicator2, {
...
var DropdownMenuRadioItem = /*#__PURE__*/t__namespace.forwardRef(function (_a, ref) {
  var className = _a.className,
    children = _a.children,
    props = __rest(_a, ["className", "children"]);
  return jsxRuntime.jsxs(RadioItem2, __assign({
    ref: ref,
    className: cn("focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center rounded-sm py-1.5 pr-2 pl-8 text-sm transition-colors outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className)
  }, props, {
    children: [jsxRuntime.jsx("span", {
...
var DropdownMenuLabel = /*#__PURE__*/t__namespace.forwardRef(function (_a, ref) {
  var className = _a.className,
    inset = _a.inset,
    props = __rest(_a, ["className", "inset"]);
  return jsxRuntime.jsx(Label2, __assign({
    ref: ref,
    className: cn("px-2 py-1.5 text-sm font-semibold", inset && "pl-8", className)
  }, props));
});
DropdownMenuLabel.displayName = Label2.displayName;
var DropdownMenuSeparator = /*#__PURE__*/t__namespace.forwardRef(function (_a, ref) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return jsxRuntime.jsx(Separator2, __assign({
    ref: ref,
...
function WeekView(_a) {
  ...
  var weekStart = t.useMemo(function () {
  ...
  var processedDayEvents = t.useMemo(function () {
...
function EventCalendar(_a) {
  var _b = _a.events,
    ...
    onEventCreate = _a.onEventCreate,
    onEventSelect = _a.onEventSelect;
  var _d = t.useState(new Date()),
    currentDate = _d[0],
    setCurrentDate = _d[1];
  var _e = t.useState(initialView),
    view = _e[0],
    setView = _e[1];
  ...
  var viewTitle = t.useMemo(function () {
    if (view === "month") {
